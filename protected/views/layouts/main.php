...
<head>
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/owl-carousel/owl.carousel.js"></script>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle"
                                       data-toggle="dropdown"><?php echo Yii::app()->user->name; ?>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><?php if (Yii::app()->user->getRole() == 2) echo CHtml::link('Керування', array('site/admin')); ?></li>
                                    </ul>
                                </li>
                            </ul>
                        <?php } ?>
