                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-xs-2 col-md-1">
                                <img
                                    src="<?php echo Yii::app()->request->baseUrl; ?>/images/profile/<?php echo $comment->author->profile->photo; ?>"
                            ...
                            <div class="col-xs-10 col-md-11">
                                <div id="commnet_noimage">
                                    <div>
                                        <div class="mic-info">
                                            Автор:<?php echo CHtml::link($comment->author->login, array('user/view', 'id' => $comment->author_id)); ?>
                                            створено: <?php echo date('d.m.Y H:i:s', $comment->created); ?>
                                            редаговано: <?php echo date('d.m.Y H:i:s', $comment->updated); ?>
                                        </div>
                                    </div>
